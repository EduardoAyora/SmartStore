 ...
 */
public class VistaCrearPersona extends javax.swing.JInternalFrame {
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "La persona ya existe", "Error", JOptionPane.WARNING_MESSAGE);
        } 
        catch (Exception ex) {
            JOptionPane.showMessageDialog(this, "No se ha podido crear", "Error", JOptionPane.WARNING_MESSAGE);
            ex.printStackTrace();
        }
